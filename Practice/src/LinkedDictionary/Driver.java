...
// Create a dictionary 
        DictionaryInterface<String, String> nameList = new LinkedDictionary<String, String>();
...
// Remove first item
        System.out.println("\n\n\nRemoving first item Nancy - Nancy's number is " +
                nameList.remove(nancy) + " should be 555-7894");
