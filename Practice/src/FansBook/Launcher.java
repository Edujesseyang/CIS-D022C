...
public class Launcher {
    ...
    public static void main(String[] args) {
        ...
        mainUserDB.add(u3);
        mainUserDB.add(u4);
        // add them to the graph as vertex
    ...
    public static void login(Scanner sc) {
        ...
        while (true) {
            ...
            tries--;
            if (tries == 0) {
                System.out.println("Failed 3 times to enter password. Going back to main menu...");
                break;
            }
        }
    }
        ...
        while (true) {
            ...
            if (select == 1) {
                ...
                while (true) {
                    ...
                    System.out.println("Confirm needs to match the password.");
                    tries--;
                    if (tries == 0) {
                        System.out.println("Tried 3 times, going back to last page...");
                        break;
                    }
                }
            }
    ...
    public static void createUser(Scanner sc) {
        ...
        while (password.isEmpty()) {
            ...
            if (password.length() > 10 || password.length() < 5) {
                System.out.println("Password needs to be longer than 5 characters but no more than 10.");
                password = "";
            }
    ...
    public static void help() {
        System.out.println("""
                ...
                And also add other user to the friend list, check your friend's information.
                And check your friend's connection. As well as delete a user from your friend list.
                ---------------------------------------------------------------
                """);
    }
